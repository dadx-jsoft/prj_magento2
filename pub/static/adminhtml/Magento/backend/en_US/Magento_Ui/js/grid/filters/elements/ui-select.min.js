...
this.filterChips().updateActive();},error:function(){this.options([]);},complete:function(){this.validationLoading(false);this.setCaption();}});}});});